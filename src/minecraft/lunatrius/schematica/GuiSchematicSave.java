...
public class GuiSchematicSave extends GuiScreen {
	...
	public void initGui() {
		...
		this.btnPointA = new GuiButton(id++, this.centerX - 130, this.centerY - 55, 100, 20, "Red point");
		this.controlList.add(this.btnPointA);

		this.btnDecAX = new GuiButton(id++, this.centerX - 130, this.centerY - 30, 30, 20, "-");
		...
		this.btnIncAX = new GuiButton(id++, this.centerX - 60, this.centerY - 30, 30, 20, "+");
		this.controlList.add(this.btnIncAX);

		this.btnDecAY = new GuiButton(id++, this.centerX - 130, this.centerY - 5, 30, 20, "-");
		...
		this.btnIncAY = new GuiButton(id++, this.centerX - 60, this.centerY - 5, 30, 20, "+");
		this.controlList.add(this.btnIncAY);

		this.btnDecAZ = new GuiButton(id++, this.centerX - 130, this.centerY + 20, 30, 20, "-");
		...
		this.btnIncAZ = new GuiButton(id++, this.centerX - 60, this.centerY + 20, 30, 20, "+");
		this.controlList.add(this.btnIncAZ);

		this.btnPointB = new GuiButton(id++, this.centerX + 30, this.centerY - 55, 100, 20, "Blue point");
		this.controlList.add(this.btnPointB);

		this.btnDecBX = new GuiButton(id++, this.centerX + 30, this.centerY - 30, 30, 20, "-");
		...
		this.btnIncBX = new GuiButton(id++, this.centerX + 100, this.centerY - 30, 30, 20, "+");
		this.controlList.add(this.btnIncBX);

		this.btnDecBY = new GuiButton(id++, this.centerX + 30, this.centerY - 5, 30, 20, "-");
		...
		this.btnIncBY = new GuiButton(id++, this.centerX + 100, this.centerY - 5, 30, 20, "+");
		this.controlList.add(this.btnIncBY);

		this.btnDecBZ = new GuiButton(id++, this.centerX + 30, this.centerY + 20, 30, 20, "-");
		...
		this.btnIncBZ = new GuiButton(id++, this.centerX + 100, this.centerY + 20, 30, 20, "+");
	...
	protected void actionPerformed(GuiButton guiButton) {
		if (guiButton.enabled) {
			if (guiButton.id == this.btnPointA.id) {
				...
				this.btnEnable.displayString = this.settings.isRenderingGuide ? "Disable" : "Enable";
				this.btnSave.enabled = this.settings.isRenderingGuide;
