...
public class ItemRenderer {
	...
	public void renderItem(ItemStack var1) {
		...
		if (var1.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[var1.itemID].getRenderType())) {
			...
			if (var1.itemID < 256) {
				GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/terrain.png"));
				textureSize = Client.terrainTexSize;
			} else {
				GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, this.mc.renderEngine.getTexture("/gui/items.png"));
				textureSize = Client.itemsTexSize;
			}
			float txSize16 = textureSize*16;
			float atlasSize = textureSize*textureSize;
			float texNudge = 1.0f / ((atlasSize) * 2.0f);
			float reciprocal = 1.0f / (float)textureSize;
			float tileSizeBorder = (float)textureSize - 0.01f;
			Tessellator var2 = Tessellator.instance;
			float var3 = ((float)(var1.getIconIndex() % 16 * textureSize) + 0.0F) / txSize16;
			float var4 = ((float)(var1.getIconIndex() % 16 * textureSize) + tileSizeBorder) / txSize16;
			float var5 = ((float)(var1.getIconIndex() / 16 * textureSize) + 0.0F) / txSize16;
			float var6 = ((float)(var1.getIconIndex() / 16 * textureSize) + tileSizeBorder) / txSize16;
			float var7 = 1.0F;
			float var8 = 0.0F;
			float var9 = 0.3F;
			...
			float var14;
			float var15;
			for(var12 = 0; var12 < textureSize; ++var12) {
				var13 = (float)var12 / (float)textureSize;
				var14 = var4 + (var3 - var4) * var13 - texNudge;
				var15 = var7 * var13;
			...
			for(var12 = 0; var12 < textureSize; ++var12) {
				var13 = (float)var12 / (float)textureSize;
				var14 = var6 + (var5 - var6) * var13 - texNudge;
				var15 = var7 * var13 + reciprocal;
	...
	public void renderItemInFirstPerson(float var1) {
		...
		if (var5 != null) {
			...
			var8 = MathHelper.sin(var7 * 3.1415927F);
			var9 = MathHelper.sin(MathHelper.sqrt_float(var7) * 3.1415927F);
			GL11.glTranslatef(-var9 * 0.4F, MathHelper.sin(MathHelper.sqrt_float(var7) * 3.1415927F * 2.0F) * 0.2F, -var8 * 0.2F);
			GL11.glTranslatef(0.7F * var6, -0.65F * var6 - (1.0F - var2) * 0.6F, -0.9F * var6);
			GL11.glRotatef(45.0F, 0.0F, 1.0F, 0.0F);
			
			if(CustomHandPositionHack.instance.status) {
				GL11.glTranslatef(CustomHandPositionHack.instance.xOff.value, CustomHandPositionHack.instance.yOff.value, CustomHandPositionHack.instance.zOff.value);
				GL11.glRotatef(CustomHandPositionHack.instance.rotX.value, 1, 0, 0);
				GL11.glRotatef(CustomHandPositionHack.instance.rotY.value, 0, 1, 0);
				GL11.glRotatef(CustomHandPositionHack.instance.rotZ.value, 0, 0, 1);
			}
			
			GL11.glEnable(32826 /*GL_RESCALE_NORMAL_EXT*/);
			var7 = var3.getSwingProgress(var1);
			var8 = MathHelper.sin(var7 * var7 * 3.1415927F);
			var9 = MathHelper.sin(MathHelper.sqrt_float(var7) * 3.1415927F);
			...
			var8 = MathHelper.sin(var7 * 3.1415927F);
			var9 = MathHelper.sin(MathHelper.sqrt_float(var7) * 3.1415927F);
			GL11.glTranslatef(-var9 * 0.3F, MathHelper.sin(MathHelper.sqrt_float(var7) * 3.1415927F * 2.0F) * 0.4F, -var8 * 0.4F);
