...
public class ItemRenderer {
    ...
    public void renderItem(EntityLiving var1, ItemStack var2) {
        ...
        if (var2.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[var2.itemID].getRenderType())) {
            ...
            float var5 = ((float)(var4 % 16 * textureSize) + 0.0F) / txSize16;
            float var6 = ((float)(var4 % 16 * textureSize) + tileSizeBorder) / txSize16;
            float var7 = ((float)(var4 / 16 * textureSize) + 0.0F) / txSize16;
            float var8 = ((float)(var4 / 16 * textureSize) + tileSizeBorder) / txSize16;
            float var9 = 1.0F;
            float var10 = 0.0F;
            float var11 = 0.3F;
            ...
            for(var14 = 0; var14 < textureSize; ++var14) {
                var15 = (float)var14 / (float)textureSize;
                var16 = var6 + (var5 - var6) * var15 - texNudge;
                var17 = var9 * var15;
            ...
            for(var14 = 0; var14 < textureSize; ++var14) {
                var15 = (float)var14 / (float)textureSize;
                var16 = var8 + (var7 - var8) * var15 - texNudge;
                var17 = var9 * var15 + reciprocal;
