...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
        ...
        byte var26 = 10;
        boolean var31 = false;
        boolean renderChat = true;
        if(HideChatHack.instance.status) {
        	renderChat = false;
        }
        ...
        if(renderChat) {
	        ...
	        for(var17 = 0; var17 < this.chatMessageList.size() && var17 < var26; ++var17) {
	            if (((ChatLine)this.chatMessageList.get(var17)).updateCounter < 200 || var31) {
	                ...
	                if (var20 > 0) {
	                    ...
	                    if(this.chatMessagesBGs.get(var17)) {
	                    	this.drawRect(var33, var22 - 1, var33 + 320, var22 + 8, (int)(var20 / 1.2f) << 24);
	                    }else {
	        ...
	        GL11.glPopMatrix();
	        GL11.glEnable(3008 /*GL_ALPHA_TEST*/);
	        GL11.glEnable(GL11.GL_DEPTH_TEST); //XXX maybeaclient
	        GL11.glDisable(3042 /*GL_BLEND*/);
        }
    }
