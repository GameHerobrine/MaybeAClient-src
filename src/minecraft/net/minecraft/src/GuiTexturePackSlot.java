...
class GuiTexturePackSlot extends GuiSlot {
    ...
    protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
        ...
        var5.draw();
        this.parentTexturePackGui.drawString(Client.mc.fontRenderer, var6.texturePackFileName, var2 + 32 + 2, var3 + 1, 16777215);
        this.parentTexturePackGui.drawString(Client.mc.fontRenderer, var6.firstDescriptionLine, var2 + 32 + 2, var3 + 12, 8421504);
        this.parentTexturePackGui.drawString(Client.mc.fontRenderer, var6.secondDescriptionLine, var2 + 32 + 2, var3 + 12 + 10, 8421504);
    }
}
